...
//
//	mockgen -destination=mock_pdfgen/mock_pdfgen.go github.com/tagatac/bagoup/v2/opsys/pdfgen PDFGenerator
//
...
func (mr *MockPDFGeneratorMockRecorder) AddPage(p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddPage", reflect.TypeOf((*MockPDFGenerator)(nil).AddPage), p)
}
