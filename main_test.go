...
func TestWriteFile(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantCount: 1,
			wantErr:   `copy attachment "attachment2" to "messages-export/friend/attachments" - POSSIBLE FIX: https://github.com/tagatac/bagoup/blob/master/README.md#protected-file-access: this is a permissions error`,
		},
		{
			...
			wantCount: 1,
			wantErr:   `convert HEIC file "attachment2" to JPG: this is a goheif error`,
		},
		{
			...
			wantCount: 1,
			wantErr:   `include attachment "attachment2" in file "messages-export/friend/iMessage;-;friend@gmail.com;;;iMessage;-;friend@hotmail.com.txt": this is an outfile error`,
		},
	}
